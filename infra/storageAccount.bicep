...
resource stblob 'Microsoft.Storage/storageAccounts/blobServices@2022-09-01' = if (length(storage.blob.containers) > 0) {
...
resource stblobcontainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2022-09-01' = [for container in storage.blob.containers: if (length(storage.blob.containers) > 0) {
...
resource sttable 'Microsoft.Storage/storageAccounts/tableServices@2022-09-01' = if (length(storage.table.tables) > 0) {
  name: '${st.name}/default'
}

resource sttabletable 'Microsoft.Storage/storageAccounts/tableServices/tables@2022-09-01' = [for table in storage.table.tables: if (length(storage.table.tables) > 0) {
